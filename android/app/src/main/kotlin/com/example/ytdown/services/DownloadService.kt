...
constructor(
    ...
    suspend fun rewriteMetadata(
        ...
        // ✅ FIX: ytDlp.rewriteMetadata() é uma chamada BLOQUEANTE do Chaquo Python.
        // Sem withContext(Dispatchers.IO), ela roda na Main thread (padrão do viewModelScope),
        // bloqueia a UI e o Android mata o app por ANR — exatamente o crash que ocorria
        // ao salvar a edição do nome de uma música.
